...
save(summ_sR1, file='STM8_d_summ_sR1_6_months.Rdata')
...
save(summ_sR2, file='STM8_d_summ_sR2_3_months.Rdata')

#################     COUNTERFACTUAL SCENARIOS: PLOT   #######################################

load('STM8_d_summ_sR1_6_months.Rdata')
load('STM8_d_summ_sR2_3_months.Rdata')
...
png("~/Downloads/STM_and_SRM/output/STM8_d_occas_counter_test.png", width = 7, height = 6, units = 'in', res = 300)
...
png("~/Downloads/STM_and_SRM/output/STM8_d_occas_counter_test_legend.png", width = 10, height = 1.5, units = 'in', res = 300)
par(mar=c(0, 0, 0, 0))
